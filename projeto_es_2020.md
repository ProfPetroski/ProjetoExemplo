...
Deadline da iteração 1: 11/12/2020

**Iteração 2**

De 12/12/2020 a 12/02/2021:

-   Inicio do desenvolvimento
-   Criação de testes
-   Desenvolvimento das primeiras histórias de usuário
-   Primeiro deploy
-   Relatório da Iteração 2

Deadline da iteração 2: 12/02/2021

**Iteração 3**

De 13/02/2021 a 05/03/2021
...
De 06/03/2021 a 26/03/2021
-   Continuação do desenvolvimento
-   Criação de testes
-   Modelo de dados
-   Relatório da iteração 4

Deadline da iteração 4: 26/03/2021
...
Cada iteração será avaliada por seus entregáveis, ou seja os artefatos que compõe cada etapa do ciclo de vida do projeto de software:



##### Tabela de Entregáveis

| Entregável | Descrição | Iterações |
|--|--|--|
| README.MD | Página inicial do projeto (README.MD) com o nome do projeto, justificativa, descrição do software, papéis da equipe e demais informações que julgar necessárias. | 1|
|Ata de reunião e histórias de usuário| Participantes da reunião, tópicos discutidos e as deliberações acordadas; Histórias de usuários no formato: (Como ............. eu gostaria de ................... para ............) | 1|
| Mockups e storyboards| Utilizar uma ferramenta de de prototipagem ou esboço livre para apresentar um protótipo | 1|
| Modelo de dados| Representação das entidades, atributos e relacionamento dos dados| 4| 
| Relatório|Relatório das lições aprendidas de cada iteração: o que funcionou, o que não funcionou e o que deve ser melhorado na próxima iteração <br><ol><li>Período da iteração (Data de início e término)</li> <li>Atividades planejada</li><ol><li>Atividade e responsável</li></ol><li>Atividades realizadas</li><ol><li>Atividade e responsável</li></ol><li>Atividades não realizadas</li><ol><li>Atividade, responsável e motivo do impedimento</li></ol><li>Atividades da próxima iteração</li><ol><li>Atividade e responsável</li></ol><li>Lições aprendidas</li></ol>|1, 2, 3, 4, 5
| Identificar as histórias/atividades trabalhadas em cada iteração| Utilizar o github (ou algum outro aplicativo integrado) para gerenciar as histórias e atividades sendo desenvolvidas em cada iteração| 1, 2, 3, 4, 5|
| Desenvolvimento dirigido a testes| Escrever testes para todas as funcionalidades e classes (testes unitários, de comportamento, etc)| 2, 3, 4, 5|
|Vídeo de apresentação do software | Gravar um vídeo de demonstração do projeto finalizado de aproximadamente 2 min.|5|
